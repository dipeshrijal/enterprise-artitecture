...
public class MainA {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Product product1 = new Product("Mac Book", "This is mac book");
			Product product2 = new Product("iPhone", "This is iPhone");
			Product product3 = new Product("Dell", "This is iPhone");
			Product product4 = new Product("Acer", "This is iPhone");
...
//			orderList.add(order2);
			...
			// In add order order is assigned to the associated
			// customer with the help of customer setter in order.
